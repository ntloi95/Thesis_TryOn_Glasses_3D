...
/*void Menu_GlassesPreview::SetFaceScanMode(FaceScanPreviewMode mode)
{
	mMode = mode;
}*/
...
void Menu_GlassesPreview::LoadFaceObj(std::string filename, bool absoluteFilename, bool forceReload)
{
